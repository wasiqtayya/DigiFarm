...
<html lang="en">
<head>
    <title>Crop Details • DigiFarm</title>
            ...
            <div class="side-bar-content-wrapper d-flex flex-column h-100">
                <div class="links-content d-flex flex-column justify-content-between h-100">
                    <div class="sidebar-links-wrapper">
                        ...
                        <a href="crop.php" class="side-bar-item active-link d-flex align-items-center">
                            <svg class="side-bar-icon" xmlns="http://www.w3.org/2000/svg"
...
<div class="alert alert-success cpsave alert-dismissible fade show" role="alert">
        <div class="alert-body">
            ...
            <p>
                Crop details have been successfully saved.
            </p>
        </div>
    </div>
<!--- main sec End --->
    ...
    <div class="modal-dialog w-100">
        <div class="modal-content">
            ...
            <div class="modal-footer delete-buttn-wrapper justify-content-end">
                <button type="submit" class="btn btn-primary mb-3 cancel-button" data-bs-dismiss="modal" aria-label="Close">Cancel
                </button>
                <button type="button" class="btn btn-primary mb-3" data-bs-dismiss="modal" aria-label="Close">
                    OK
                </button>
            </div>
        </div>
